...
export const ProfilePage: React.FC = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8 space-y-8">
      ...
      {/* Role & Access Card - Visible for Hotel Manager, Admin, Owner */}
      {isHotelManager ? (
        <div className="bg-gradient-to-r from-slate-900 to-slate-800 text-white rounded-3xl p-6 sm:p-8 shadow-xl space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-700/60 pb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-base font-bold text-white">Hotel Management Authorization</h2>
                <p className="text-xs text-slate-400">
                  Active Manager Role: <span className="font-mono text-rose-400 font-bold">{getRoleLabel(activeRole)}</span>
                </p>
              </div>
            </div>
          ...
          <div className="space-y-2 text-xs">
            <p className="text-slate-300">
              Switch between management tiers:
            </p>
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-3xl p-5 sm:p-6 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="p-2.5 bg-slate-200 text-slate-700 rounded-xl">
              <Shield className="w-5 h-5" />
            </div>
            <div>
              <h3 className="text-xs font-bold text-slate-900">Account Access Level</h3>
              <p className="text-[11px] text-slate-500">
                Logged in as a verified Guest traveler.
              </p>
            </div>
          </div>
          <span className="px-3 py-1 bg-white text-slate-700 rounded-full text-xs font-bold border border-slate-200 shadow-2xs">
            Guest
          </span>
        </div>
      )}
