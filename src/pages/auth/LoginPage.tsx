      ...
      <div className="max-w-md w-full bg-white rounded-3xl p-8 border border-slate-200 shadow-xl space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-500">
            Sign in with your backend credentials or OAuth2 account
          </p>
        </div>
        ...
        <div className="space-y-2.5">
          ...
          <button
            ...
            disabled={isSubmitting || !!oauthLoading}
            className="w-full py-2.5 px-4 bg-slate-900 hover:bg-slate-800 text-white rounded-xl text-xs font-bold flex items-center justify-center gap-3 transition-colors shadow-2xs disabled:opacity-50"
          >
            {oauthLoading === 'github' ? (
              <LoadingSpinner className="py-0" text="Redirecting to GitHub..." />
            ) : (
              <>
